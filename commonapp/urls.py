...
urlpatterns = [
    ...
    path('settings_table_fields_make_index/', settings_table_fields_make_index, name='settings_table_fields_make_index'),
    path('settings_table_fields_remove_index/', settings_table_fields_remove_index, name='settings_table_fields_remove_index'),
    ...
    path('get_orders_matrix/', get_orders_matrix, name='get_orders_matrix'),
    
    # ------------------  WeGolf views ---------------------------------
    path('get_job_status/', get_job_status, name='get_job_status'),
    path('get_job_status_summary_api/', get_job_status_summary_api, name='get_job_status_summary_api'),
