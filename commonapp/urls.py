...
urlpatterns = [
    ...
    path('reset_password_with_token/', reset_password_with_token, name='reset_password_with_token'),
    path('start_impersonate/', start_impersonate, name='start_impersonate'),
    ...
    path('get_grouped_table_records/', get_grouped_table_records, name='get_grouped_table_records'),
    path('get_available_groups_for_table/', get_available_groups_for_table, name='get_available_groups_for_table'),
